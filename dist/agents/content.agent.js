...
export class ContentAgent {
    ...
    artifactTypeFor(jobType) {
        ...
        if (jobType === 'content.calendar' || jobType === 'content.fight-card-daily-package')
            return 'content.calendar-plan';
        if (jobType === 'content.blog-topic-suggestions' || jobType === 'content.user-dashboard-opportunities' || jobType === 'content.blog-seo-daily-articles')
    ...
    buildPlanFallback(job, topic) {
        if (job.jobType === 'content.fight-card-daily-package')
            return this.buildFightCardDailyPackage(job, topic);
        if (job.jobType === 'content.blog-seo-daily-articles')
            return this.buildBlogSeoDailyPackage(job, topic);
    ...
    buildFightCardDailyPackage(job, topic) {
        return {
    ...
    buildBlogSeoDailyPackage(job, topic) {
    ...
    planTitle(jobType, topic) {
        ...
        if (jobType === 'content.fight-card-daily-package')
            return `Fight-card daily package: ${topic}`;
        if (jobType === 'content.blog-seo-daily-articles')
            return `Daily blog/SEO article package: ${topic}`;
    ...
    contentTypeFor(jobType) {
        ...
        if (jobType === 'content.fighter-profile-page-brief')
            return 'profile_page';
        if (jobType === 'content.fight-card-daily-package')
            return 'fight_card_daily_package';
        if (jobType === 'content.blog-seo-daily-articles')
            return 'blog_seo_daily_articles';
