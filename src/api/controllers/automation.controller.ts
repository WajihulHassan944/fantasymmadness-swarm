...
import {
  bulkUpdateAutomationSettings,
  getAutomation,
  getAutomationDashboard,
  listAutomationLogs,
  listAutomations,
  resetAutomationSetting,
...
export async function listAutomationsHandler(req: Request, res: Response): Promise<void> {
...
export async function getAutomationHandler(req: Request, res: Response): Promise<void> {
  const item = await getAutomation(req.params.key);
  res.json({ ok: true, item, requestId: req.requestId });
}

export async function updateAutomationSettingHandler(req: Request, res: Response): Promise<void> {
  const body = updateSettingBodySchema.parse(req.body || {});
  const item = await updateAutomationSetting(req.params.key, body);
  res.json({ ok: true, item, requestId: req.requestId });
}

export async function bulkUpdateAutomationSettingsHandler(req: Request, res: Response): Promise<void> {
  const body = bulkUpdateBodySchema.parse(req.body || {});
  const items = await bulkUpdateAutomationSettings(body.items);
  res.json({ ok: true, items, requestId: req.requestId });
}

export async function resetAutomationSettingHandler(req: Request, res: Response): Promise<void> {
...
export async function triggerAutomationEventHandler(req: Request, res: Response): Promise<void> {
...
export async function automationDashboardHandler(req: Request, res: Response): Promise<void> {
  const dashboard = await getAutomationDashboard();
  res.json({ ok: true, dashboard, requestId: req.requestId });
}

export async function listAutomationLogsHandler(req: Request, res: Response): Promise<void> {
